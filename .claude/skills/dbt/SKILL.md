...
|-------------|------------|
| `seed_`, `raw_` | [Raw](references/raw.md) |
| `snp_`, `stg_` | [Staging](references/staging.md) |
| `int_` | [Intermediate](references/intermediate.md) |
| `dim_`, `fct_`, `brg_`, `mart_`, `agg_`, `rpt_`, `util_` | [Datamart](references/datamart.md) |
